...
| B06 | THE RECEIPT | body | REMOTION | `ShiftReceipt` *(reel-local)* | 20.63s | Two 62-char vectors aligned; indices 19 and 60 turn terracotta; `1.1102230246251565e-16` scales to 104px, glossed `exactly 2**-53 — adjacent floats, one step apart` |
